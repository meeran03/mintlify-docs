...
<section aria-labelledby="create-assistant-overview">
  ...
  <p>
    Use this endpoint when you want to provision a voice AI assistant from your own product, CRM, onboarding flow, or internal admin system.
    A created assistant can define its model settings, voice, speech recognition behavior, tools, webhooks, and telephony provider.
  </p>
  <ul>
