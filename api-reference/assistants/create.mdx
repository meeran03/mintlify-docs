...
<section aria-labelledby="create-assistant-api-behavior">
  ...
  <p>
    The JSON body mirrors the assistant creation form in the Burki dashboard. The same groups appear in the API: basic info, LLM, TTS, STT, interruptions, tools, and telephony.
  </p>
  <p>
