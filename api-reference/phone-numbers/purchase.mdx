...
description: 'Purchase a Twilio or Telnyx phone number, configure webhooks automatically, and assign it to a Burki voice AI assistant.'
openapi: 'POST /api/v1/phone-numbers/purchase'
---
