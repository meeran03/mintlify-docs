...
description: 'Search available Twilio or Telnyx phone numbers by country, area code, locality, region, pattern, provider, and result limit.'
openapi: 'POST /api/v1/phone-numbers/search'
---
