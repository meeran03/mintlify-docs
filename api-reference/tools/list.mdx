---
title: 'List Tools'
description: 'List, search, filter, sort, and paginate custom tools available in your Burki organization for assistant workflows.'
openapi: 'GET /api/v1/tools'
---

<section aria-labelledby="list-tools-overview">
  <h2 id="list-tools-overview">List Organization Tools</h2>
  <p>
    Use this endpoint to show available tools in an admin UI, audit tool health, or let builders attach existing tools to assistants.
  </p>
  <ul>
    <li>Filter by tool type and active status.</li>
    <li>Search by tool name, display name, or description.</li>
    <li>Sort by usage, performance, creation date, or update date.</li>
  </ul>
</section>

<section aria-labelledby="list-tools-api-behavior">
  <h2 id="list-tools-api-behavior">How this endpoint behaves</h2>
  <p>
    The list is paginated and supports search, filters, and sort order. Use it for admin screens, audits, and attaching existing tools to assistants without creating duplicates.
  </p>
  <p>
    Tool records include type, status, and usage-oriented sort fields so you can find stale or high-traffic tools quickly.
  </p>
</section>
