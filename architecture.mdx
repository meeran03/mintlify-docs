...
| **STT** | Converts caller's speech to text | Deepgram, ElevenLabs, Azure, Uplift, Speechmatics, Telnyx, Soniox |
| **LLM** | Understands context and generates responses | OpenAI, Azure OpenAI, Anthropic, Gemini, Groq, xAI, custom HTTP/WebSocket |
| **TTS** | Converts AI response back to speech | ElevenLabs, Deepgram, Cartesia, Azure, Inworld, Resemble, OpenAI, Kokoro, Uplift, Murf, Soniox |
