...
- **Free Trial**: 200 connected trial minutes for new organizations
...
<Info>
Public roadmap items move as customer deployments and provider support change. For planned features, breaking changes, or migration timing, check your dashboard announcements or contact support.
</Info>
