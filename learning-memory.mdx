...
For full request/response examples and the complete route surface, see [Learning and Memory API](/api-reference/learning/overview).
...
| `GET` | `/api/learning/memories/{id}/edges` | Get graph relationships for a memory |
...
| `PATCH` | `/api/learning/assistants/{id}/prompts/{id}/canary` | Update canary percentage |
...
| `GET` | `/api/learning/assistants/{id}/prompts/{id}/gates` | Inspect promotion gates |
...
| `POST` | `/api/learning/assistants/{id}/eval-datasets/import` | Import dataset and cases |
| `POST` | `/api/learning/assistants/{id}/eval-datasets/{id}/publish` | Publish dataset |
| `POST` | `/api/learning/assistants/{id}/eval-datasets/{id}/cases` | Add test case |
| `PUT` | `/api/learning/assistants/{id}/eval-datasets/{id}/cases/{id}` | Update test case |
| `DELETE` | `/api/learning/assistants/{id}/eval-datasets/{id}/cases/{id}` | Delete test case |
| `POST` | `/api/learning/assistants/{id}/eval-datasets/{id}/cases/from-trace` | Create case from trace |
...
| Method | Endpoint | Description |
|--------|----------|-------------|
| `GET` | `/api/learning/assistants/{id}/stats` | Assistant learning stats |
| `GET` | `/api/learning/graph-stats` | Organization memory graph stats |
| `GET` | `/api/learning/assistants/{id}/memory-graph` | Assistant memory graph |
| `POST` | `/api/learning/assistants/{id}/dspy/optimize` | Run DSPy optimization |
| `GET` | `/api/learning/call-traces` | List call traces |
| `GET` | `/api/learning/call-traces/{id}` | Get full trace detail |
