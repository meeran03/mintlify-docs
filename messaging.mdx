...
graph TD
    ...
    F -->|Vonage| V[Send via Vonage API]
...
<CardGroup cols={2}>
  ...
  <Card title="SMS Conversations" icon="comments" href="/api-reference/messaging/sms-conversations">
    Conversation, session, export, and archive APIs
  </Card>
  <Card title="SMS Logs" icon="bug" href="/api-reference/messaging/sms-logs">
    Delivery logs, stats, and debug timelines
  </Card>
  <Card title="SMS Compliance" icon="shield" href="/api-reference/messaging/sms-compliance">
    Verify SMS use cases and outbound eligibility
  </Card>
  <Card title="SMS 10DLC" icon="id-card" href="/api-reference/messaging/sms-10dlc">
