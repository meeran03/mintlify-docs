...
|----------|---------|-------------|
| `/api/v1/phone-numbers/search` | POST | Search available numbers |
| `/api/v1/phone-numbers/purchase` | POST | Purchase a phone number |
| `/api/v1/phone-numbers/release` | POST | Release a phone number |
| `/api/v1/phone-numbers/countries` | GET | List supported countries |
...
| **Reliability** | Provider-backed infrastructure | Provider-backed infrastructure |
