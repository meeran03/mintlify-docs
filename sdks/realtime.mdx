...
<ul>
  <li>Automatic connection management with context manager</li>
  <li>Async iteration for events</li>
  <li>Clean disconnection on exit</li>
</ul>
...
<p><strong>Features:</strong></p>
<ul>
  <li>Async iterator pattern (<code>for await...of</code>)</li>
  <li>Explicit connect/disconnect control</li>
...
<p><strong>Features:</strong></p>
<ul>
  <li>Channel-based event delivery</li>
  <li>Select statement for concurrent handling</li>
  <li>Explicit goroutine management</li>
</ul>
