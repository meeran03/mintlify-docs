...
**Provider-Specific:**
- **Deepgram connection issues:** Check DEEPGRAM_API_KEY environment variable
- **Azure authentication failed:** Verify subscription key and region match your Speech resource
