...
<CardGroup cols={3}>
  ...
  <Card title="🎙️ ElevenLabs Scribe v2" icon="waveform-lines" href="/stt-providers/elevenlabs">
    **Multi-Language Excellence**
    ...
    Vendor-reported low latency, broad language support, and advanced VAD-based speech detection.
  </Card>
...
Azure Speech provides managed speech recognition with broad language support and Microsoft ecosystem integration.
