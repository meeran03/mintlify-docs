...
<Tabs>
  ...
  <Tab title="Inworld">
    ...
    |-------------|-------|---------|
    | **Business Communication** | `inworld-tts-1` | Consistent, professional |
    | **Creative Content** | `inworld-tts-1.5-max` | More expressive range |
    | **Multilingual** | `inworld-tts-1.5-mini` | Lower latency with expanded language support |
    | **Gaming/Entertainment** | `inworld-tts-1.5-max` | Maximum expression |
  </Tab>
